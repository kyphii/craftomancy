...
public class BlockManaCollector extends BlockContainer implements IRegistrableBlock {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
        ...
        if (!world.isRemote) {
            FMLNetworkHandler.openGui(player, MagicMod.instance, GuiHandler.GuiId.GUI_MANA_COLLECTOR.ordinal(),
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof TileEntityManaCollector) {
                ((TileEntityManaCollector) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public int getComparatorInputOverride(IBlockState blockState, World worldIn, BlockPos pos) {
        return ((TileEntityManaCollector) worldIn.getTileEntity(pos)).getManaScaled(15);
    }
}
